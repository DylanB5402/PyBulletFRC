...
class WPILibWSInterface:
    ...
    def send_encoder_data(self, left_count, right_count):
        # self.ws.send()
        left_encoder_data = {'data' :  {
            '>count' : left_count, 'device': '9', 'type': 'Encoder'
        }}
        right_encoder_data = {'data' :  {
            '>count' : right_count, 'device': '1', 'type': 'Encoder'
        }}
...
while(True):
    ...
    interface.send_encoder_data(687, 687)
